...
\begin{frame}{Stärkere Authentisierungsverfahren}
  \begin{block}{Zwei-Faktor-Authentisierung}
    Verwendet zwei der drei Konzepte, um seine Identität nachzuweisen:
    \begin{itemize}
  ...
  \begin{block}{Authentisierung in zwei Schritten}
    Dabei werden in zwei Schritten zwei verschiedenartige Identitätsprüfungen durchgeführt (z.B. Passwort und Einmalpasswort), die auf dem gleichen Faktor (z.B. Wissen) bassieren.
    \begin{itemize}
      \item Wissen (z.B. Passwort)
      \item Besitz (z.B. Bankkarte)
      \item Persönliche Eigenschaften (Biometrie)
